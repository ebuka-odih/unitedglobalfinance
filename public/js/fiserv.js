/*  ___ _
   ...
   -----------------------------------------------------------------------------------------------------------
   jQuery 1.11.3 by JS Foundation, (c) 2005, 2015 jQuery Foundation, Inc. | jquery.org/license..............36
   jQuery Mobile 1.5.0 by jQuery Foundation, Inc., Copyright 2010, 2017 jQuery Foundation, Inc..............47
   Modernizr 2.8.3 by Modernizr.com Team, MIT & BSD | Modernizr.com.........................................52
   Debounce 1.0.0 by Jesse Fowler, Copyright 2014 Fiserv. All rights reserved...............................58
   Text Replace 1.0.0 by JP Larson, Copyright 2019 Fiserv. All rights reserved..............................74
   Slideshow 2.11.0 by Jesse Fowler, Copyright 2015 Fiserv. All rights reserved............................209
   Slider 2.1.0 by Jesse Fowler, Copyright 2019 Fiserv. All rights reserved................................546
   CMS Include 2.0.0 by JP Larson, Copyright 2017 Fiserv. All rights reserved..............................663
   Page Class 2.0.0 by JP Larson, Copyright 2018 Fiserv. All rights reserved...............................719
   Ajax Post 2.0.0 by JP Larson, Copyright 2018 Fiserv. All rights reserved................................738
   Replace With Checkmarks 1.1.0 by Jesse Fowler, Copyright 2017 Fiserv. All rights reserved...............796
   Text Resizer 4.2.0 by Jesse Fowler, Copyright 2018 Fiserv. All rights reserved..........................820
   Online Banking 1.5.4 by JP Larson, Copyright 2019 Fiserv. All rights reserved...........................903
   Validate Form 1.3.0 by JP Larson, Copyright 2018 Fiserv. All rights reserved...........................1176
   Field History 2.0.1 by JP Larson, Copyright 2018 Fiserv. All rights reserved...........................1347
   Personalization 2.5.2 by Jesse Fowler, Copyright 2015 Fiserv. All rights reserved......................1446
   Site Notice 4.1.1 by Jesse Fowler, Copyright 2018 Fiserv. All rights reserved..........................1675
   Smooth Scroll 2.2.0 by JP Larson, Copyright 2018 Fiserv. All rights reserved...........................1803
   Accessibility Tab Expand 2.1.1 by JP Larson, Copyright 2018 Fiserv. All rights reserved................1950
   Captcha 3.0.0 by Jesse Fowler, Copyright 2015 Fiserv. All rights reserved..............................2028
   Expander 4.0.0 by Jesse Fowler & Kristen Rogers, Copyright 2015 Fiserv. All rights reserved............2130
   Scroll Trigger 2.2.0 by Jesse Fowler & Kristen Rogers, Copyright 2016 Fiserv. All rights reserved......2278
   Scroll To 1.3.0 by Jesse Fowler, Copyright 2015 Fiserv. All rights reserved............................2336
   Get Queries 2.1.0 by JP Larson, Copyright 2018 Fiserv. All rights reserved.............................2420
   Lightcase 3.0.2 by @cornelboppart, GPL license.........................................................2463
   Text Color Based On Background Color 1.0.0 by Jesse Fowler, Copyright 2019 Fiserv. All rights reserved.4243
   Responsive Zoom 3.1.0 by Jesse Fowler, Copyright 2015 Fiserv. All rights reserved......................4282
   Resize Class 1.0.1 by JP Larson, Copyright 2019 Fiserv. All rights reserved............................4394
   ----------------------------------------------------------------------------------------------------------- */
            ...
            textReplace = function (obj, settings, instanceObj) {
                ...
                _proto.replaceTextNodes = function (obj, pair) {
                    ...
                    for (let i = 0, n = text.length; i < n; i++) {
                        ...
                        text[i].node.textContent = parsed.body.innerHTML.replace(pair.regex, pair.replace);
                        if (text[i].node.textContent.length == 0) {
                            text[i].parent.removeChild(text[i].node);
                        }
                    }
                    return text;
                }
...
jQuery.fn.slideShow = function (options) {
    ...
    images.each(function () {
        if (jQuery(this).parent('a').attr('href')) {
            var duplicateElement = jQuery('<a />');
            duplicateElement.attr('href', jQuery(this).parent('a').attr('href'));
        } else {
...
(function (jQuery) {
    jQuery.fn.slider = function (options) {
        var settings = jQuery.extend(true, {
            slideAllVisible: false
        }, options),
            amountOfVisibleSlides = 0,
            registerSlider = function (obj) {
                var slider = {};
                slider.sliderName = "slider-" + (jQuery.fn.slider.sliders.length + 1);
                jQuery.fn.slider.sliders.push(slider);
                obj.attr('id', slider.sliderName);
            },
            cleanUpSlider = function (obj) {
                obj.find('.slider-previous, .slider-next, .slider-toc').remove();
                obj.children('tbody').children('tr').children('td').each(function (index) {
                    if (jQuery(this).attr('id') && jQuery(this).attr('id').match(/^slide-(\d)*$/)) {
                        jQuery(this).attr('id', '');
                    }
                });
            },
            calcAmountOfVisibleSlides = function (obj) {
                amountOfVisibleSlides = Math.floor(obj.innerWidth() / obj.children('tbody').children('tr').children('td').outerWidth(true));
            },
            setActiveSlide = function (control, obj, direction) {
                var activeIndex = 0;
                var currentIndex = 0;
                calcAmountOfVisibleSlides(obj);
                obj.children('tbody').children('tr').children('td').each(function (index) {
                ...
                if (direction == 'next') {
                    if (settings.slideAllVisible == true) {
                        if (currentIndex == obj.children('tbody').children('tr').children('td').length - amountOfVisibleSlides) {
                            var activeIndex = 0;
                        } else {
                            var activeIndex = currentIndex + amountOfVisibleSlides;
                        }
                    } else {
                        if (currentIndex >= obj.children('tbody').children('tr').children('td').length - amountOfVisibleSlides) {
                            var activeIndex = 0;
                    ...
                    if (settings.slideAllVisible == true) {
                        if (currentIndex < amountOfVisibleSlides) {
                            var activeIndex = obj.children('tbody').children('tr').children('td').length - amountOfVisibleSlides;
                        } else {
                            var activeIndex = ((Math.ceil(((currentIndex + 1) - amountOfVisibleSlides) / amountOfVisibleSlides) - 1) * amountOfVisibleSlides);
                        }
                    } else {
                        if (currentIndex <= 0) {
                            var activeIndex = obj.children('tbody').children('tr').children('td').length - amountOfVisibleSlides;
                ...
                obj.find('.slide-active').removeClass('slide-active');
                obj.children('tbody').children('tr').children('td').eq(activeIndex).addClass('slide-active');
                var nextId = '#' + obj.attr('id') + '-slide-' + (activeIndex + 1);
                control.attr('href', nextId);
            },
            initSlider = function (obj) {
                registerSlider(obj);
                cleanUpSlider(obj);
                if (obj.find('.slide-active')) {
                    obj.find('.slide-active').removeClass('slide-active');
                    obj.children('tbody').children('tr').children('td').eq(0).addClass('slide-active');
                }
                obj.children('tbody').children('tr').children('td').each(function (index) {
                    jQuery(this).attr('id', obj.attr('id') + '-slide-' + (index + 1));
                });
                var previousObj = jQuery('<a class="slider-previous fa-angle-left"><span class="visuallyhidden">Previous</span></a>');
                previousObj.on('mousedown touchstart', function (event) {
                    setActiveSlide(jQuery(this), obj, 'previous');
                });
                previousObj.smoothScroll({
                    event: 'mouseup touchend',
                    updateHash: false,
                    fixResize: true,
                    animation: {
                        obj: obj.children('tbody').children('tr')
                    }
                });
                obj.children('tbody').prepend(previousObj);
                var nextObj = jQuery('<a class="slider-next fa-angle-right"><span class="visuallyhidden">Next</span></a>');
                nextObj.on('mousedown touchstart', function () {
                    setActiveSlide(jQuery(this), obj, 'next');
                });
                nextObj.smoothScroll({
                    event: 'mouseup touchend',
                    updateHash: false,
                    fixResize: true,
                    animation: {
                ...
                obj.children('tbody').append(nextObj);
                var initialCountClass = 'initial-count-' + obj.find('td').length;
                obj.addClass(initialCountClass);
            },
            init = function (obj) {
                for (var i = 0, n = obj.length; i < n; i++) {
                    initSlider(obj.eq(i));
...
// Online Banking 1.5.4 by JP Larson, Copyright 2019 Fiserv. All rights reserved.
(function () {
    jQuery.fn.onlineBanking = function (options) {
        var settings = jQuery.extend(true, {
            ...
            error: function (obj, msg) {
                console.log(msg);
                obj.addClass(obj.onlineBanking.errorClass);
                var timer = setTimeout(function () {
                    obj.removeClass(obj.onlineBanking.errorClass).removeClass(obj.onlineBanking.loadingClass);
                }, 3000);
            }
        }, options),
            _obj = this,
            ob = {
                retail: {
                    ...
                    "5.4-SecureNow": function () {
                        jQuery.ajax({
                            url: "https://" + _obj.onlineBanking.retail.server + "/PBI_PBI1151/js/remoteLoginSecure",
                            dataType: "script",
                            success: function (result) {
                                var submitCallback = function () {
                                    ...
                                    errorCallback = function () {
                                        _obj.onlineBanking.error(_obj, "RO 5.4-SecureNow Errored. Make sure the client has added their stage and all domains to their RO profile.");
                                    },
                                    args = {
                ...
                business: {
                    ...
                    "6.0": function () {
                        jQuery.ajax({
                            url: "https://" + _obj.onlineBanking.business.server + "/EBC_EBC1151/js/RemoteLogon",
                            dataType: "script",
                            success: function () {
                                var submitCallback = function () {
                                    ...
                                    errorCallback = function () {
                                        _obj.onlineBanking.error(_obj, "BO 6.0 Errored. Make sure the client has added their stage and all domains to their BO profile.");
                                    },
                                    args = {
                                        errorCallback: errorCallback,
                                        submitCallback: submitCallback,
            ...
            init = function (obj) {
                for (var i = 0, n = obj.length; i < n; i++) {
                    ...
                    if (typeof jQuery.fn.validateForm == "function"){
                        _obj.validateForm({
                            focus: {
                                scroll: false
                            },
...
// Validate Form 1.3.0 by JP Larson, Copyright 2018 Fiserv. All rights reserved.
(function () {
    jQuery.fn.validateForm = function (options) {
        var settings = jQuery.extend(true, {
            ...
            listeners: "click blur input change", // The event listeners used to determine when to remove the class (string)
            ...
            classThis = function (currentElement, validationType, e) {
                    var valid = function () {
                        if (currentElement.get(0).checkValidity() && currentElement.get(0).value.length > 0) {
                            return true;
                        } else {
                            return false;
                        }
                    ...
                    classed = function () {
                        if (/radio/i.test(currentElement.get(0).type)) {
                            return currentElement.closest('fieldset');
                        } else {
                    ...
                    switch (validationType) {
                        ...
                        case _obj.validateForm.class.invalid:
                            ...
                            break;
                        default:
                            classed().addClass(validationType);
                    }
                    return true;
            },
            scrollPosition = function (currentElement) {
                return currentElement.offset().top - (jQuery(window).height() * _obj.validateForm.focus.position);
            },
            ...
            focuser = function (obj) {
                if (_obj.validateForm.focus.active) {
                    obj.focus();
                    if (_obj.validateForm.focus.scroll && !isfixed(obj) && typeof _obj.validateForm.focus.position == "number") {
            ...
            validate = function (form) { //Validates all inputs.
                let objs = form.find('input:not([disabled]):not([type=hidden]), select:not([disabled]), textarea:not([disabled])');
                for (let i = 0, n = objs.length; i < n; i++) {
                    if (!objs.eq(i).get(0).checkValidity()) {
                        invalidField(objs.eq(i));
                        return false;
                    }
                }
                return true;
            ...
            addValidityObjects = function (obj) {
                const validationObj = jQuery('<span class="validation"></span>');
                const errorObj = jQuery('<span class="error">' + _obj.validateForm.defaultErrorMessage + '</span>');
                const inlineErrorObj = obj.find('.error');
                obj.append(validationObj);
                if (inlineErrorObj.length <= 0) {
                    obj.append(errorObj);
                }
                return true;
            },
            ...
            init = function (obj) {
                for (var i = 0, n = obj.length; i < n; i++) {
                    let thisForm = obj.eq(i);
                    const inputs = thisForm.find('input, select, textarea');
                    thisForm.addClass(_obj.validateForm.class.form);
                    thisForm.find(_obj.validateForm.submitObject.selector).on('click', function () {
                        const validatingForm = thisForm;
                        if (!validatingForm.get(0).noValidate) {
                            if (validate(validatingForm)) {
                    ...
                    addValidityObjects(thisForm.find('label, fieldset'));
                    const requiredObjects = thisForm.find('[required]');
                    for (let r = 0, q = requiredObjects.length; r < q; r++) {
                        classThis(requiredObjects.eq(r), _obj.validateForm.class.required);
                        classThis(requiredObjects.eq(r), _obj.validateForm.class.valid);
                    }
                    inputs.on(_obj.validateForm.listeners, function (e) {
                        const thisObj = jQuery(this);
                        clearTimeout(classDebounce[thisObj.get(0).name]);
                        classDebounce[thisObj.get(0).name] = setTimeout(function () {
                            classThis(thisObj, _obj.validateForm.class.valid);
                        }, 500);
                    });
                    thisForm.on("reset", function (e) {
                        for (key in classDebounce) {
                            clearTimeout(classDebounce[key]);
                        }
                        for (let r = 0, q = inputs.length; r < q; r++) {
                            const thisObj = inputs.eq(r);
                            setTimeout(function () {
                                thisObj.get(0).value = thisObj.get(0).value;
                                classThis(thisObj, _obj.validateForm.class.valid);
                            }, 100);
                        }
                    });
                }
                jQuery('html').addClass('fiserv-validate-form');
            };
...
// Personalization 2.5.2 by Jesse Fowler, Copyright 2015 Fiserv. All rights reserved.
// Customized greeting
(function (jQuery) {
            ...
            init = function (obj) {
                ...
                if (settings.popupForm && settings.personalizationEnable && window.localStorage.getItem(settings.localStorageTest)) {
                    ...
                    var personalizationInitialize = function () {
                        var personalizationFirstName;
                        if (window.sessionStorage.getItem(settings.localStorageFirstName)) {
                            personalizationFirstName = window.sessionStorage.getItem(settings.localStorageFirstName);
                        }
                        if (window.localStorage.getItem(settings.localStorageFirstName)) {
                    ...
                    personalizationClose.each(function (index) {
                        jQuery(this).on("click", function () {
                            window.sessionStorage.setItem(settings.localStorageFirstName, 'Skipped');
                            settings.popupForm.removeClass('active');
                        });
                    });
...
// Site Notice 4.1.1 by Jesse Fowler, Copyright 2018 Fiserv. All rights reserved.
            ...
            this.each(function () {
                ...
                if ($noticeHtml.html().length > settings.reqLength) {
                    ...
                    if (firstTable.length) {
                        ...
                        $notice.find('.noticeHtml > table').addClass('text-color-based-on-background-color');
                    } else {
...
(function (jQuery) {
    ...
    jQuery.fn.scrollTrigger = function (options) {
        ...
        var settings = jQuery.extend({
            ...
            enableLastActivatedTriggerClass: false,
            lastActivatedTriggerClass: "scroll-active-current",
            scrollMin: 0,
        ...
        $this.each(function (index) {
            ...
            if (height >= settings.scrollMin) {
                if (settings.enableLastActivatedTriggerClass == true) {
                    jQuery('.' + settings.lastActivatedTriggerClass).removeClass(settings.lastActivatedTriggerClass);
                }
                if (targetProvided) {
                    settings.target.addClass(settings.triggerClass);
                    if (settings.enableLastActivatedTriggerClass == true) {
                        settings.target.addClass(settings.lastActivatedTriggerClass);
                    }
                } else {
                    jQuery(this).addClass(settings.triggerClass);
                    if (settings.enableLastActivatedTriggerClass == true) {
                        jQuery(this).addClass(settings.lastActivatedTriggerClass);
                    }
                }
            ...
            getQueries = function (obj) {
                ...
                if (matches) {
                    for (var i = 0, n = matches.length; i < n; i++) {
                        let query;
                        if (settings.decode) {
                            query = decodeURIComponent(matches[i].split('=')[1]).replace(/\+/g, " ");
                        } else {
                            query = matches[i].split('=')[1];
                        }
                        param[matches[i].split('=')[0]] = query;
                    }
...
(function (jQuery) {
    jQuery.fn.textColorBasedOnBackgroundColor = function (options) {
        var settings = jQuery.extend(true, {
            lightClass: 'light',
            darkClass: 'dark'
        }, options),
            setTextColorClass = function (obj) {
                if (obj.css('background-color') != 'transparent') {
                    var objBgColor = obj.css('background-color').match(/(\d*), (\d*), (\d*)/);
                    objBgColor.splice(0, 1);
                    var rgb = objBgColor;
...
// Responsive Zoom 3.1.0 by Jesse Fowler, Copyright 2015 Fiserv. All rights reserved.
...
(function (jQuery) {
    jQuery.fn.resizeClass = function (options) {
        ...
        init = function (obj) {
            for (var i = 0, n = obj.length; i < n; i++) {
                let thisObj = obj.eq(i);
                thisObj.removeClass(_obj.resizeClass.resizeClass);
            }
            jQuery(window).resize(function () {
                for (var i = 0, n = obj.length; i < n; i++) {
                    ...
                    timer[i] = setTimeout(function () {
                        thisObj.removeClass(_obj.resizeClass.resizeClass);
                    }, _obj.resizeClass.debounceDuration);
                    thisObj.addClass(_obj.resizeClass.resizeClass);
                }
            });
            jQuery('html').addClass('fiserv-resize-class');
        };
        _obj.resizeClass = settings;
        init(this);
        return this;
    };
}(jQuery));
